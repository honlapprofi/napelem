		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Mar 09,2022 <span class="changelog-version">Lite Version 5.0.6</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Added : Cross Domain Copy Paste','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Glassmorphism (Section/Column/Widget)','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : WPML String Transition XML','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Mar 09,2022 <span class="changelog-version">Pro Version 5.0.9</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Display Rules : HTML Rendering Option for Section','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Google Map : Connection with WP Search Filter','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Accordion : Expand/Collapse Button','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Countdown : Scarcity Countdown','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Darkmode : Global Color','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
